...
import com.note.mytest.banner.ConstraintLayoutBannerActivity;
import com.note.mytest.banner.DataBean;
import com.note.mytest.banner.GalleryActivity;
import com.note.mytest.banner.ImageAdapter;
import com.note.mytest.banner.ImageTitleAdapter;
import com.note.mytest.banner.ImageTitleNumAdapter;
import com.note.mytest.banner.MultipleTypesAdapter;
import com.note.mytest.banner.RecyclerViewBannerActivity;
import com.note.mytest.banner.TVActivity;
import com.note.mytest.banner.TouTiaoActivity;
import com.note.mytest.banner.Vp2FragmentRecyclerviewActivity;
...
public class BannerActivity extends BaseActivity {
    ...
    @OnClick( {R.id.style_image, R.id.style_image_title, R.id.style_image_title_num, R.id.style_multiple,
            R.id.style_net_image, R.id.change_indicator, R.id.rv_banner, R.id.cl_banner, R.id.vp_banner,
             R.id.banner_tv, R.id.gallery, R.id.topLine})
